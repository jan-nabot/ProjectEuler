...
def diagL2R():
    ...
    for it0 in range(0, 17):
        for it1 in range(0,17): 
            for it2 in range(0, 4):
                cache.append(int(realtable2[it0+it2][it1+it2]))
            curval = cache[0] * cache[1] * cache[2] * cache[3] 
            if curval > biggest:
                biggest = curval
            cache = []
    return biggest
...
def hori():
    ...
    for it0 in range(0, 20):
        for it1 in range(0, 17):
            for it2 in range(0, 4):
                cache.append(int(realtable2[it0][it1+it2]))
            curval = cache[0] * cache[1] * cache[2] * cache[3] 
            if curval > biggest:
                biggest = curval
            cache = []
...
def verti():
    ...
    for it0 in range(0, 20):
        for it1 in range(0, 17):
            for it2 in range(0, 4):
                cache.append(int(realtable2[it1+it2][it0])) 
            curval = cache[0] * cache[1] * cache[2] * cache[3] 
            if curval > biggest:
                biggest = curval
            cache = []
...
biggie = []
for itA in (verti, hori, diagL2R, diagR2L):
    biggie.append(itA())
biggie.sort()
print("Biggest value found: ", biggie[-1])
